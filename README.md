...
Text your [OpenClaw](https://openclaw.ai) agent via iMessage or SMS.
...
```bash
git clone https://github.com/andesco/openclaw-sendblue ~/.openclaw/extensions/sendblue
...
Now text the Sendblue number from your phone. You should get a reply from your OpenClaw agent!
